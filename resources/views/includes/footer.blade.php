...
<!-- jQuery -->
<script src="/template-mintos/vendors/jquery/dist/jquery.min.js"></script>

<!-- Bootstrap Core JavaScript -->
<script src="/template-mintos/vendors/popper.js/dist/umd/popper.min.js"></script>
<script src="/template-mintos/vendors/bootstrap/dist/js/bootstrap.min.js"></script>

<!-- FeatherIcons JavaScript -->
<script src="/template-mintos/dist/js/feather.min.js"></script>

<!-- Slimscroll JavaScript -->
<script src="/template-mintos/dist/js/jquery.slimscroll.js"></script>

<!-- Toggles JavaScript -->
<script src="/template-mintos/vendors/jquery-toggles/toggles.min.js"></script>
<script src="/template-mintos/dist/js/toggle-data.js"></script>

<!-- Init JavaScript -->
<script src="/template-mintos/dist/js/init.js"></script>
