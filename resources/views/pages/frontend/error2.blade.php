...
@section('meta_tags')
    <title>Corona :: Error, ya se le entrego un codigo DSCTO</title>
    <meta name="title" content="Corona :: Error, ya se le entrego un codigo DSCTO"  />
    <meta name="description" content="Corona :: Error, ya se le entrego un codigo DSCTO" />
    <!-- Schema.org markup for Google+ -->
    <meta itemprop="name" content="Corona :: Sunset" >
    <meta itemprop="description" content="Corona :: Error, ya se le entrego un codigo DSCTO">
    ...
    <meta name="twitter:description" content="Corona :: Error, ya se le entrego un codigo DSCTO">
    ...
    <meta property="og:description" content="Corona :: Error, ya se le entrego un codigo DSCTO" />
