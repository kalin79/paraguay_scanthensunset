...
@section('meta_tags')
    <title>Corona :: Error en Subir la foto </title>
    <meta name="title" content="Corona :: Error en Subir la foto"  />
    <meta name="description" content="Corona :: Error en Subir la foto" />
    <!-- Schema.org markup for Google+ -->
    <meta itemprop="name" content="Corona :: Sunset" >
    <meta itemprop="description" content="Corona :: Error en Subir la foto">
    ...
    <meta name="twitter:description" content="Corona :: Error en Subir la foto">
    ...
    <meta property="og:description" content="Corona :: Error en Subir la foto" />
...
@endsection
@section('content')
    <restriccion-corona></restriccion-corona>
@endsection